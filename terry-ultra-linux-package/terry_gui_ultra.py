...
<body>
    ...
    <div class="container">
        ...
        <div class="chat-container" id="chatContainer">
            <div class="message terry-message">
                <strong style="background: linear-gradient(135deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">🚀 Terry is online!</strong><br><br>
                I'm your advanced AI coding assistant with quantum-enhanced capabilities. I can help you with:<br><br>
    ...
    <div id="settingsModal" class="modal">
        <div class="modal-content">
            ...
            <h2 style="background: linear-gradient(135deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: 30px;">⚙️ Advanced Settings</h2>
    ...
    <div id="donateModal" class="modal">
        <div class="modal-content">
            ...
            <h2 style="background: linear-gradient(135deg, #f093fb, #f5576c); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: 30px;">❤️ Support Terry's Development</h2>
            ...
            <div style="margin: 30px 0;">
                <div style="background: rgba(102, 126, 234, 0.1); border: 1px solid rgba(102, 126, 234, 0.3); padding: 20px; border-radius: 16px; margin: 15px 0;">
                    <strong style="color: #667eea;">💳 PayPal</strong><br>
                ...
                <div style="background: rgba(240, 147, 251, 0.1); border: 1px solid rgba(240, 147, 251, 0.3); padding: 20px; border-radius: 16px; margin: 15px 0;">
                    <strong style="color: #f093fb;">💵 Cash App</strong><br>
    ...
    <script>
        ...
        function sendMessage() {
            ...
            setTimeout(() => {
                ...
                if (lowerMessage.includes('hello') || lowerMessage.includes('hi')) {
                    response = `<strong style="background: linear-gradient(135deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Greetings! 🚀</strong><br>I'm Terry, your quantum-enhanced AI assistant. I'm ready to help you create something amazing today!`;
        ...
        function saveSettings() {
            ...
            successDiv.innerHTML = '<strong style="background: linear-gradient(135deg, #667eea, #764ba2); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">✅ Settings Updated!</strong><br>Your preferences have been saved successfully.';
