#!/usr/bin/env python3
"""
Terry with Waving Arm
Waving with left arm, thumbs up with right arm
"""

def create_waving_terry_logo():
    """Create Terry with waving arm and thumbs up"""
    
    svg_content = '''<?xml version="1.0" encoding="UTF-8"?>
<svg width="200" height="200" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    <!-- Waving gradients with baby blue -->
    <defs>
    ...
    <!-- Tool Belt -->
    <rect x="62" y="120" width="76" height="12" rx="5" fill="url(#waveBelt)" stroke="#000000" stroke-width="1.5" filter="url(#waveShadow)"/>
    ...
    <!-- Leaner Tools -->
    <!-- Streamlined Wrench -->
    <g transform="translate(68, 117)" filter="url(#waveShadow)">
    ...
    <!-- Lean Drill -->
    <g transform="translate(92, 117)" filter="url(#waveShadow)">
    ...
    <!-- Lean Hammer -->
    <g transform="translate(115, 117)" filter="url(#waveShadow)">
    ...
    <!-- Athletic mouth curve (now more cheerful) -->
    ...
    <g transform="translate(45, 105)" filter="url(#waveShadow)">
        ...
        <!-- Animated wave arm segment -->
        <g transform="translate(8, 2)">
            <!-- Elbow joint -->
            <circle cx="2" cy="-2" r="3" fill="#6b7280" stroke="#000000" stroke-width="2"/>
            
            <!-- Lower arm segment -->
            <g transform="rotate(-30 2 -2)">
                <rect x="0" y="0" width="15" height="8" rx="4" fill="url(#waveBodyGrad)" stroke="#000000" stroke-width="2"/>
                
                <!-- Hand waving motion path -->
                <animateTransform
                    attributeName="transform"
                    attributeType="XML"
                    type="rotate"
                    values="0 -30 0 -2; 20 -30 0 -2; 0 -30 0 -2"
                    dur="2s"
                    repeatCount="indefinite"/>
                
                <!-- Waving hand -->
                <ellipse cx="12" cy="4" rx="6" ry="7" fill="#475569" stroke="#000000" stroke-width="2"/>
                
                <!-- Waving hand details -->
                <rect x="9" y="1" width="5" height="3" rx="1.5" fill="#374151" opacity="0.4"/>
                <circle cx="10" cy="2.5" r="1" fill="#6b7280"/>
            </g>
        </g>
    </g>
    
    <!-- THUMBS UP RIGHT ARM (unchanged greatness) -->
    <g transform="translate(130, 105)" filter="url(#waveShadow)">
        ...
        <!-- SAME GREAT THUMBS UP! (unchanged) -->
    ...
    <g filter="url(#babyBlueGlow)">
        ...
        <!-- Secondary antenna light (waving) -->
...
def main():
    """Create Terry with waving arm and thumbs up"""
    print("👋 Creating Terry with Waving Arm...")
    
    waving_logo = create_waving_terry_logo()
    with open('terry_logo_waving.svg', 'w') as f:
        f.write(waving_logo)
    
    print("✅ Terry with Waving Arm created successfully!")
    print("📁 File created: terry_logo_waving.svg")
    print("\n👋 Waving Features:")
    print("  • Left arm ALWAYS WAVING (continuous animation)")
    print("  • Right arm PERMANENT THUMBS UP")
    print("  • Animated antenna (pulsing light)")
    print("  • Signal waves animation")
    print("  • Baby blue eyes and mouth (unchanged)")
    print("  • SAME GREAT thumbs up (unchanged)")
    print("  • Lean body (less fat)")
    print("  • Friendly, welcoming personality")
    print("  • Perfect dual-arm animation")
    
    # Update GUI to use waving logo
    print("\n🔄 Updating ultra-modern GUI with waving Terry...")
    ...
    if gui_file.exists():
        ...
        # Update to use waving logo
        content = content.replace('terry_logo_leaner.svg', 'terry_logo_waving.svg')
        
        with open(gui_file, 'w') as f:
            f.write(content)
        
        print("✅ Ultra-modern GUI updated with Waving Terry!")
